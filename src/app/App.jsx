...
const projects = [
	{
		...
		description: '•	Built a fully functional frontend clone of Spotify with a modern UI.Added custom video support features to enhance user engagement. Tech Stack: React, Tailwind CSS, HTML, CSS, JavaScript.',
		image: GlobalShare
	},
	{
		...
		<div className={style.app}>
			...
			<div id='Home' className={style.home}>
				...
				<div className={style["contact-nav"]}>
					<a className={style.github} target="_blank" href='https://github.com/Nileshnimawat' >
						<AiFillGithub size="30px" color='black' />
					</a>
					<a className={style.linkedin} target="_blank" href='https://www.linkedin.com/' >
				...
				<div className={style.container}>
					<div className={style["footer-info"]}>
						...
						<div className={style.social}>
							<h3>Social</h3>
							<div className="">
								<a className={style.git} target="_blank" href='https://github.com/Nileshnimawat' >
