...
export const projects = [
  {
    ...
    description:
      "Built a fully functional Twitter clone with modern UI and real-time chat features using React, Tailwind CSS, Node.js, Express, MongoDB, and WebSockets.",
    image: GlobalShare,
  },
  {
    ...
    description:
      "Built a frontend clone of Spotify with modern UI and video support using React and Tailwind CSS.",
    image: GlobalShare,
  },
  {
